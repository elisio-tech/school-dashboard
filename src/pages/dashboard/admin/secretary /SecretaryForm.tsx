...
import { areaOptions } from "../../../../utils/utils";
...
export default function SecretaryForm({ closeModal: externalCloseModal }: any) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (image) {
        const storageRef = ref(storage, `secretary/${image.name}`);
      ...
      <div className="custom-scrollbar h-[450px] overflow-y-auto px-2 pb-3">
        ...
        <div className="mt-5 mb-12">
          ...
          <div>
            ...
            <p className="sr-only">Selected Values: {areas.join(", ")}</p>
          </div>
        </div>
      </div>
